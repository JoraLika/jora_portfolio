        ...
        <div className="contact_content">
          ...
          <div className="contact_info">
            <div className="contact_card">
              ...
              <span className="contact_card-data">jora.likaa@gmail.com</span>
            ...
            <div className="contact_card">
              ...
              <span className="contact_card-data">+355 67 30 97 674</span>

              <a href="https://api.whatsapp.com/send?phone=+355673097674&text=Hello, more information!" className="contact_button">
                Write me 
                <i className="bx bx-right-arrow-alt contact_button-icon"></i>
              </a>
            </div>
